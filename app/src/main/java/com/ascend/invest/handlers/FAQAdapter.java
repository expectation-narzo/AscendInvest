...
public class FAQAdapter extends RecyclerView.Adapter<FAQAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvDescription.setText(faq.getDescription());
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            tvTitle = itemView.findViewById(R.id.tv_faq_question);
            tvDescription = itemView.findViewById(R.id.tv_faq_answer);
        }
    }

    public static class SupportTicketAdapter extends RecyclerView.Adapter<SupportTicketAdapter.ViewHolder> {
