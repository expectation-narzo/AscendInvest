...
import com.ascend.invest.admin.data.repository.AdminRepository;
import com.ascend.invest.admin.di.AdminAppModule_ProvideDatabaseReferenceFactory;
import com.ascend.invest.admin.di.AdminAppModule_ProvideFirebaseDatabaseFactory;
import com.ascend.invest.admin.ui.AdminViewModel;
import com.ascend.invest.admin.ui.AdminViewModel_HiltModules;
...
public final class DaggerAdminApp_HiltComponents_SingletonC {
  ...
  public static AdminApp_HiltComponents.SingletonC create() {
  ...
  private static final class ActivityCImpl extends AdminApp_HiltComponents.ActivityC {
    ...
    @Override
    public void injectAdminMainActivity(AdminMainActivity arg0) {
    }
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_ascend_invest_admin_ui_AdminViewModel, AdminViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_ascend_invest_admin_ui_AdminViewModel = "com.ascend.invest.admin.ui.AdminViewModel";

      @KeepFieldType
      AdminViewModel com_ascend_invest_admin_ui_AdminViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends AdminApp_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_ascend_invest_admin_ui_AdminViewModel, ((Provider) adminViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.ascend.invest.admin.ui.AdminViewModel 
  ...
  private static final class SingletonCImpl extends AdminApp_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.ascend.invest.admin.data.repository.AdminRepository 
          return (T) new AdminRepository(singletonCImpl.provideDatabaseReferenceProvider.get());

          case 1: // com.google.firebase.database.DatabaseReference 
          return (T) AdminAppModule_ProvideDatabaseReferenceFactory.provideDatabaseReference(singletonCImpl.provideFirebaseDatabaseProvider.get());

          case 2: // com.google.firebase.database.FirebaseDatabase 
          return (T) AdminAppModule_ProvideFirebaseDatabaseFactory.provideFirebaseDatabase();
